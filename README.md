...
**Шаги:**
1. Отправить GET-запрос на https://org.1-ofd.ru/registration/login-mail.
...
**Шаги:**
1. Отправить GET-запрос на https://org.1-ofd.ru/api/cp-core/user/saperew170@ahaks.com/name.
2. Проверить, что статус ответа равен 200.
3. Проверить, что тело ответа не пустое.
